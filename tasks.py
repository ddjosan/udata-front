...
I18N_ROOT = 'udata_front/theme/govrs/translations'

THEME_ROOT = os.path.join(ROOT, 'udata_front/theme', 'govrs')
...
def i18n(ctx, update=False):
    ...
    with ctx.cd(ROOT):
        ...
        set_po_metadata(os.path.join(I18N_ROOT, 'govrs.pot'), 'en')
        for lang in LANGUAGES:
            pofile = os.path.join(I18N_ROOT, lang, 'LC_MESSAGES', 'govrs.po')
